...
export default function Login() {
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/admin/login', user);
          ...
          <form className="form-gloating">
            ...
            <div className="col-12 mt-3 mb-3">
              <div className="form-floating">
                <input dir='ltr' type="text" className="text-center" required onChange={inputHandler} name="phone" />
            ...
            <div className="col-12 mt-3 mb-3">
              <div className="form-floating">
                <input dir='ltr' type="password" className="text-center" required onChange={inputHandler} name="password" />
                <label>رمز عبور</label>
              </div>
            </div>

            <div dir='ltr' className="col-auto mt-3 mb-4">
              <ButtonSubmit onClick={submitForm} loading={loading} className="btn-success" width='100%'>ورود</ButtonSubmit>
            </div>
          </form>
        </div>
      </div>
